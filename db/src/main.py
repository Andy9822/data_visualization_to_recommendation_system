...
for dataset in datasets:
    if populated_datasets[dataset]:
        print('Populating db with dataset:', dataset)
        ...
        for index, row in df.iterrows():
            ...
            for genre_id in genres_ids:
                genre_title_id = GenreTitle(genre_id, title_id).insert()
            ...
            view_id = View(title_id, user_id, device_id, player_id).insert()
